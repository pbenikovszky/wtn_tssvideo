...
$document->addStyleSheet("components/com_tssvideo/assets/css/tssvideo_newvideo.css");
...
<div class="tss-page-container">
    ...
    <div class="tss-sidebar">
        <div class="tss-sidebar-wrapper">
            ...
            <div class="menu-buttons">
                ...
                <div class="tssmenu-btn tss-menu-active" id="btn-new-video"><span>Új videó</span></div>
    ...
    <div class="tss-new-video-container">
        <h2>Új videó hozzáadása</h2>
        <div class="tss-newvideo-row">
            <span class="tss-newvideo-label">YouTube ID</span>
            <input class="tss-input-textfield" id="youtube_id" type="text" placeholder="YouTube azonosító">
            <div class="tss-newvideo-button tss-yid-validate-button" id="btn-validate"><span>Validálás</span></div>
        </div>
...
?>
        ...
        <div class="tss-newvideo-row">
            <div class="tss-newvideo-button" id="btn-create"><span>Létrehozás</span></div>
        </div>
...
$document = JFactory::getDocument();
$document->addScript("components/com_tssvideo/assets/js/tssvideo_newvideo.js");
